// resources/js/Pages/OperationalCosts/Create.jsx
...
export default function Create({ auth }) {
    const { data, setData, post, processing, errors, reset } = useForm({
        nama_biaya: '',
        tipe_biaya: 'per_jam', // Nilai default
        nilai_biaya: '',
        satuan: '',
        catatan: '',
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('operational-costs.store'), {
    ...
    return (
        <AuthenticatedLayout
            auth={auth}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Tambah Biaya Operasional Baru</h2>}
        >
            <Head title="Tambah Biaya Operasional" />
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        required
                                        placeholder="Contoh: Gaji Roaster, Biaya Gas"
                                    />
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        type="number"
                                        name="nilai_biaya"
                                        value={data.nilai_biaya}
                                        className="mt-1 block w-full"
                                        step="0.01"
                                        min="0"
                                        onChange={(e) => setData('nilai_biaya', e.target.value)}
                                        required
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        placeholder="Contoh: Rupiah/Jam, Rupiah/Batch"
                                    />
